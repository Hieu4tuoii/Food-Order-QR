...
public class CustomerController {
    ...
    @GetMapping("/{id}")
    public ResponseData<?> getCustomerDetail(@PathVariable @Min(value = 1, message = "customerId must be equals or greater than 1") Long id) {
        log.info("Getting customer detail by id: {}", id);
        CustomerDetailResponse customerDetailResponse = customerService.getById(id);
        return ResponseData.<CustomerDetailResponse>builder()
    ...
    @PostMapping("/")
    public ResponseData<?> saveCustomer(@Valid @RequestBody CustomerCreationRequest request) {
    ...
    @PutMapping("/")
    public ResponseData<?> updateCustomer(@Valid @RequestBody CustomerUpdateRequest request) {
    ...
    @DeleteMapping("/{id}")
    public ResponseData<?> deleteCustomer(@PathVariable @Min(value = 1, message = "customerId must be equals or greater than 1") Long id) {
    ...
    @GetMapping("/")
    public ResponseData<?> getCustomerList(@RequestParam(value = "keyword", required = false) String keyword,
